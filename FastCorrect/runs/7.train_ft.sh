...
DATA_PATH=/root/std_ftb_sports_corpus_en.bin   #<Path-to-AISHELL1-Binary-Data>
export PYTHONPATH=$EXP_HOME/FC_utils:$PYTHONPATH

PRETRAINED=/root/fastcorrect/models/pretrain.wiki/checkpoint16.pt  #<PATH-to-Pretrain-Save-Dir>/checkpoint10.pt
SAVE_DIR=/root/fastcorrect/models/finetune.ftb   #<PATH-to-AISHELL1-Save-Dir>
mkdir -p $SAVE_DIR
fairseq-train $DATA_PATH --task fastcorrect \
        ...
        --max-epoch 35 --update-freq 4 --fp16 --num-workers 16 \
