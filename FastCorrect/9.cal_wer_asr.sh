...
#result_data_file='/root/fastcorrect/asr_eval_data/test/data.json'
#result_data_file='/root/fastcorrect/models/finetune/results_best_asr_b0_t0.0/dev/data.json'
#result_data_file='/root/sports_corpus2/test/data.json'
#result_data_file='/root/fastcorrect/models/finetune/results_best_asr_b0_t0.0/test/data.json'
#result_data_file='/root/asr/articles/asr_data.json'
#result_data_file='/root/asr/articles/fc_asr_data.json'
#result_data_file='/root/fastcorrect/models/finetune.ftb/results_best_asr_b0_t0.0/test/data.json'
result_data_file='/root/std_ftb_sports_corpus_en/test/data.json'
...
dict=$EXP_HOME/dictionary/short.dict.CN_char.txt
#$1
