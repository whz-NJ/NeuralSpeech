...
processed_corpus_root_dir = "../sports_corpus2"
        ...
        for file in files:
            ...
            if file_path.endswith(".docx"):
                ...
                for paragraph in doc.paragraphs[1:]:
                    corpus_list.extend([sentence.replace(" ", "") + '\n' for sentence in preprocess.normAndTokenize4Ch(paragraph.text,
                                                                                                                       min_sentence_len=5,
                ...
                with open(file_path, 'r', encoding='utf-8') as infile:
                    for line in infile.readlines():
                        corpus_list.extend([sentence.replace(" ", "") + '\n' for sentence in preprocess.normAndTokenize4Ch(line,
                                                                         min_sentence_len=5,
                                                                         split_sentences=True)])
