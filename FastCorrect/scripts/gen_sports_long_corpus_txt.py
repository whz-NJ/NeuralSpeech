...
processed_corpus_root_dir = "../sports_long_corpus1"
        ...
        for file in files:
            ...
            if file_path.endswith(".docx"):
                ...
                for paragraph in doc.paragraphs[1:]:
                    sentences = preprocess.longNormAndTokenize(paragraph.text, min_sentence_len=3)
                ...
                with open(file_path, 'r', encoding='utf-8') as infile:
                    for line in infile.readlines():
                        sentences = preprocess.longNormAndTokenize(line, min_sentence_len=3)
                        for sentence in sentences:
                            sentence = sentence.replace(" ", "")
                            corpus_list.append(sentence + "\n")
