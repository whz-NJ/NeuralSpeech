...
#hypo_input_file_names = [f'hypo_std_train_noised_corpus.txt', r'hypo_std_valid_noised_corpus.txt', r'hypo_std_test_noised_corpus.txt']
#ref_input_file_names = [f'ref_std_train_noised_corpus.txt', r'ref_std_valid_noised_corpus.txt', r'ref_std_test_noised_corpus.txt']
        ...
        for line in infile.readlines():
            ...
            for token in tokens:
                if len(token) == 1:
                    ...
                    else: # 英文字母或特殊符号的拼音是它本身，不加入 g2pM_dict
                        continue
                else:  # 英文单词的拼音是它本身，不加入 g2pM_dict
                    continue
